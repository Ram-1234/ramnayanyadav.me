        ...
        <div className="contactinfo">
          <div className="contacts-details">
            ...
            <a
              ...
              href="https://www.linkedin.com/in/ramnayan-yadav-33371b165/"
              target="_block"
            >
            ...
            <a
              className="same-icon-color"
              href="https://twitter.com/ramnayan1096"
              target="_block"
            >
            ...
            <a
              className="same-pintrest-color"
              href="https://in.pinterest.com/yaryan1096/_saved/"
              target="_block"
            >
              <i class="fab fa-pinterest"></i>
            </a>
          </div>
          <form className="form contact-bg" id="contact-form" name="contact" method="post" novalidate="novalidate">
            ...
            <div id="success">
                <p class="green textcenter"> Your message was sent successfully! I will be in touch as soon as I
                    can. </p>
            </div>
            <div id="error">
